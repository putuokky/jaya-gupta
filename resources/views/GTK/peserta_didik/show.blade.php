								...
								<tr class="border-t">
									<td class="px-4 py-3 text-sm">{{ $data->firstItem() + $i }}</td>
                                    	  @php
                                                    ...
                                                    @endphp
									<td class="px-4 py-3 text-sm text-indigo-600"><a href="/data-peserta-didik/perSekolah/{{ $npsn }}">{{ $r->nama }}</a></td>
									...
									<td class="px-4 py-3 text-sm text-center">{{ $r->laki_laki_count }}</td>
									<td class="px-4 py-3 text-sm text-center">{{ $r->perempuan_count }}</td>
                                    <td class="px-4 py-3 text-sm text-center">{{ $r->laki_laki_count + $r->perempuan_count }}</td>
								</tr>
							@endforeach
						</tbody>
